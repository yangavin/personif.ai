...
def generate_streaming_response(user_input: str, system_prompt: str = None) -> Iterator[str]:
...
def chat_session():
    ...
    system_prompt = "You are a helpful, conversational AI assistant. Be concise but informative."
